...
// return ifadesi
            ...
            int enb=Math.max(4,5); // hem veri gidiyor, hem veri dönüyor//asagida tanimi yok programdan otomatik geliyor

            int toplam = toplamGetir(3,5); // hem veri alır ve hemde döndürür.
